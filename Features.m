classdef Features
    properties
        features = ["raw_acc:magnitude_stats:mean", ...
    ...
    methods
        function featureDescription = getFeatureDescription(obj, featureIndex)
            featureDescription = obj.features(featureIndex);
        end

        function featuresIndex = getFeaturesIndex(obj, featuresDescription)
            [~, featuresIndex] = intersect(obj.features,featuresDescription,"stable");
        end
    end
end